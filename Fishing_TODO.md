...
|---|---|---|---|
| FISH-TODO-070 | 2026-09-08 | PWA page copy | PR60 unified home/KB root, Gear Guides, Techniques and Catch Log card/page subtitles exactly as requested, using shared strings and permanent routing regression coverage. Final head `cd47dc9ce39660840de493346e7df9fda72a14e5`; CI #307 / `34191643311`; merge `ecd9f3d52ca8180ea4f48ec888e7574105deafda`; production #308 / `34191692935` succeeded including Pages deployment. DONE. |
| FISH-TODO-069 | 2026-09-08 | KB media | PR60 promoted the exact Cranberry Lake picture handoff, preserved authored Markdown/identity, validated the uploaded PNG and final bytes, registered explicit local media and advanced KB dataVersion to `2026-09-08-kb-v1-cranberry-lake-picture-1` (54 entities). All other domain records preserved. Same CI/merge/production evidence as FISH070. See pwa/RELEASE_2026-09-08_CRANBERRY_COPY.md. DONE. |
...
The complete prior completed-task table, including FISH001–004, 035–057 and the historical duplicate-number handoff row, is preserved in `History/2026-09-07-pre-recovery/Fishing_TODO.md` and Git history. No completed task has been reopened or discarded. The duplicate historical FISH060 handoff identifier remains retired as `ARCHIVE-2026-09-06-HANDOFF`. The next new canonical task ID is FISH-TODO-071. Future work begins from current main and this backlog; do not resume closed release branches or one-time migrations.
