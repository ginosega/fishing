...
| FISH-TODO-060 | 2026-09-06 | Project handoff | Preserved the exact unmerged Gear release and reconciled canonical state for a new Chat-mode conversation. The release itself remains open as FISH-TODO-058; this handoff does not imply deployment. |