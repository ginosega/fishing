...
FISH-TODO-084 through FISH-TODO-090 and FISH-TODO-092 through FISH-TODO-094 are DONE. FISH-TODO-091 is WAITING ON USER requirements signoff in draft PR96 and remains unimplemented; FISH-TODO-077/P2 remains DEFERRED. The canonical TODO retains all existing fishing/gear research and purchase uncertainty. All seven originally deferred required pictures are resolved; the historically optional generic inline-spinner now has the user-supplied Kingforest image through FISH088. Production cutover and automated/hosted acceptance are complete. FISH063's old media-authoring policy and FISH039's setup recording are superseded for v2; they do not justify reintroducing retired structures. PowerBait hook-size and loop-knot guidance remain unresolved. The next unused canonical task ID is FISH-TODO-095. No approved future feature is treated as already deployed.