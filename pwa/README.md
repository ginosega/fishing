...
## FISH091 production state — September 11, 2026

FISH091 is **live in production** through [PR105](https://github.com/ginosega/fishing/pull/105), source `44fa3bcbff289d2a7aa37c4967e0f5f195b53ca0`, release `01c5ed3535d358086032b0985e2af87b`, [run 34676802369](https://github.com/ginosega/fishing/actions/runs/34676802369). Normal online startup is lightweight and does not provision the complete offline cache. The service worker supports current-production online browsing plus an explicit, verified complete offline generation prepared from **Connection Status → Update offline library**. Existing complete generations remain usable as fallback until explicitly refreshed; failed/corrupt refresh attempts leave the previous complete generation intact. Hosted verification passed with 214 v2 files. FISH077/P2 remains deferred.
