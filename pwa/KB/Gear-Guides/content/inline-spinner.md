...
| Mepps Aglia | The classic inline spinner — French-style blade, consistent flash, tons of sizes/colors. | Trout, bass, panfish, pike | Universal spinner for rivers and lakes; great when fish are moderately active. | Steady medium |
| Panther Martin Classic / Hammered Series | Inline blade mounts directly on the shaft (no clevis) — produces stronger vibration and flash. | Trout, smallmouth, and river bass | Excels in current or stained water due to heavy thump and tight spin. | Medium-fast to fast |
| Rooster Tail by Worden’s (Yakima Bait Co.) | Has a pulsating hackle tail and thin willow-style blade for high flash, subtle vibration. | Trout, panfish, smallmouth | Great in clear or slow-moving water where subtle presentation is key. | Slow to medium |
| Blue Fox Vibrax | Two-part body with an internal brass bell that emits low-frequency vibration — smooth, balanced rotation. | Trout, salmon, steelhead, pike | Excellent in current and deeper runs; less line twist due to its design. | Medium to fast |
| Mepps Black Fury | Similar to the Aglia but with black blade and bright dots — less flash, more contrast. | Bass, perch, trout | Ideal for overcast days or slightly stained water. |  |
| Joe’s Flies Short Striker | Combines a small inline spinner with a trailing fly (single or treble). | Trout, smallmouth, panfish | Great in streams or creeks; deadly in slow, clear water. | Slow drift or twitch |
| Yakima Bait Super Rooster Tail (Weighted) | Heavier body for longer casts, good for deeper runs or lakes. | Trout, smallmouth | When you need to reach mid-depth fish or cast far from shore. |  |
...
| Rainbow / Brown / Brook Trout | Panther Martin, Rooster Tail, Mepps Aglia | #0–#2 | Use natural colors (silver, gold, brown, olive) in clear water. |
| Smallmouth Bass | Mepps Aglia, Panther Martin, Blue Fox Vibrax | #2–#4 | Great in rivers and rocky lakes. Try chartreuse or firetiger in stained water. |
| Largemouth Bass | Mepps Black Fury, Blue Fox Vibrax | #3–#5 | Fish near weed edges or points with steady retrieve. |
