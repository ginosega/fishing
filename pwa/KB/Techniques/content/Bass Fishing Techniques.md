...
- [Core Bass Techniques](#core-bass-techniques)
  - [Finesse](#finesse)
    - [Drop Shot](#drop-shot)
    - [Ned Rig](#ned-rig)
    - [Wacky Worm](#wacky-worm)
  - [Power](#power)
    ...
    - [Swimbaits and Soft Jerkbaits](#swimbaits-and-soft-jerkbaits)
  - [Topwater](#topwater)
    - [Buzzbaits](#buzzbaits)
    - [Frogs](#frogs)
    - [Poppers](#poppers)
    - [Walking Baits](#walking-baits)
    - [Whopper Plopper](#whopper-plopper)
- [Water Clarity and Color](#water-clarity-and-color)
...
- [A Simple Two-Rod Strategy](#a-simple-two-rod-strategy)
- [Links](#links)
...
One of the best all-purpose finesse choices, especially for smallmouth, cold water, clear water, post-frontal conditions, and pressured fish. Fish it around gravel, rock, points, drop-offs, sparse grass, and other bottom structure.

Useful retrieves:
- **Pop the bottom:** small hops followed by a fall.
- **Drag and dead-stick:** slowly drag it, stop, and let the bait sit.
- **Swim and glide:** slowly swim it and let it fall periodically.
- **Straight retrieve:** useful when bass are feeding above the bottom.

Start with a light mushroom head and increase weight only enough to maintain bottom contact or control in wind/deeper water.
...
Excellent for shallow fish, docks, grass edges, visible bass, calm water, pressured fish, and the spawn/post-spawn period. Much of the lure's action occurs while it falls, so resist the urge to overwork it.

Cast tight to the target, let the worm fall on semi-slack line, watch for the line to jump or move sideways, then add a few twitches and let it fall again. Around docks, make repeated casts to the highest-percentage shade and pilings.
...
Excellent in shallow grass, stained water, windy conditions, and when active fish respond to vibration. Fish it above submerged grass, through sparse vegetation, around docks, and along edges.

Try:
- steady retrieve;
- pop-and-pause;
- ripping it free from grass;
- allowing it to sink deeper before beginning the retrieve.

If fish follow without committing, change trailer size/color, retrieve speed, or add a pause before abandoning the bait.
...
Use a frog where exposed hooks cannot go: lily pads, grass mats, slop, reeds, and heavy shallow vegetation. Also skip it beneath overhanging cover.
...
| Water | Starting Approach | Color / Profile |
| --- | --- | --- |
| Clear | Finesse, jerkbait, natural swimbait, subtle crankbait | Natural baitfish, green pumpkin, translucent/ghost colors; smaller profiles |
| Light stain | Spinnerbait, chatterbait, crankbait, wacky worm | Shad, perch, bluegill, green pumpkin; moderate flash/vibration |
| Muddy / heavily stained | Chatterbait, Colorado-blade spinnerbait, jig, rattling crankbait | Black/blue, chartreuse, dark silhouettes, strong contrast and vibration |
...
1. **Fish parallel to the bank first.** Make casts down the shoreline, along weed edges, docks, riprap, or shade before casting straight toward deep water.
2. **Fan cast.** Work multiple angles so the lure crosses depth changes and cover differently.
3. **Move until you find a pattern.** If a dock, rock transition, or particular weed edge produces a bite, look for another spot with the same features.
4. **Use a search-and-follow-up combination.** Cover water with a spinnerbait, chatterbait, crankbait, jerkbait, or topwater, then work promising areas with a wacky worm, Ned rig, jig, or other slower lure.
5. **Approach quietly.** Bass can be directly beneath overhanging banks, docks, or shallow cover close to shore.

## Kayak Fishing and Electronics

A kayak makes it easier to control casting angles and reach offshore structure.

- Position **outside** the target and cast across it rather than sitting directly on top of the fish.
- On a point or weed edge, make casts shallow-to-deep, deep-to-shallow, and parallel to the contour; one angle may be dramatically better.
- Use sonar to find bait, bottom changes, weed tops, drop-offs, humps, and fish suspended off structure.
- If fish are visible on sonar but not biting, match their exact depth before changing lure style.
- When wind is manageable, use it to make controlled drifts along a productive bank, weed line, or contour.
- After a bite, note depth, bottom type, nearby cover, wind exposure, and lure position. The goal is to reproduce the **pattern**, not merely return to the exact coordinate.

## Detecting Strikes and Setting the Hook

Different lures require different hooksets.

- **Ned rig / drop shot / light finesse:** reel down and lift or sweep. Do not use an explosive hookset on light line.
- **Wacky worm / weightless soft plastic:** watch the line. If it jumps, moves sideways, or becomes unexpectedly heavy, reel down until you feel the fish and then sweep firmly.
- **Jig / Texas-style single-hook plastic:** reel down quickly and make a firm hookset, especially with heavier hooks.
- **Spinnerbait / chatterbait / swimbait:** keep reeling until the rod loads, then sweep firmly. Do not jerk at the first tick.
- **Crankbait / jerkbait / other treble-hook lure:** let the rod load and use a controlled sweep; an extremely hard hookset can pull small treble hooks free.
- **Frog:** wait until you feel the fish's weight, then set hard and keep it moving out of vegetation.
- **Topwater with treble hooks:** resist striking at the visual splash. Keep working until you feel weight, then sweep.

When in doubt, **reel first, hookset second**. Slack line is responsible for many lost bass.

## A Simple Two-Rod Strategy

When you do not yet know the pattern:

**Spinning rod — finesse / follow-up**
- Ned rig
- Drop shot
- Wacky worm
- Small swimbait

**Baitcasting rod — search / power**
- Spinnerbait or chatterbait around cover
- Jerkbait or crankbait around open structure
- Jig for bottom/cover
- Topwater when conditions support it
...
- [What I WISH Someone Would’ve Told me About Wacky Rig Fishing](https://www.youtube.com/watch?v=FBWjutCCV9Q)
- [Stop Fishing a Jerkbait Like THIS (5 Common Mistakes)](https://www.youtube.com/watch?v=PpV9-aHjlDU)
- [The Right Way to Rig a Soft Jerkbait](https://www.youtube.com/watch?v=dOgX9l18DQk)
- [Spinnerbait Fishing Lure Tips and How to Fish Spinnerbaits (Underwater Footage)](https://www.youtube.com/watch?v=r-ba-GqRQOM)
...
- Topwater: [Topwater Fishing](kb://topwater-fishing), [Walking Bait](kb://technique-walking-bait), [Popper](kb://technique-popper), [Buzzbait](kb://technique-buzzbait), [Frogs](kb://technique-frogs)
- Rigging / tackle: [Fishing Line](kb://technique-fishing-line), [Snaps & Swivels](kb://technique-snaps-swivels), [Palomar Knot](kb://knot-palomar), [Loop / Non-slip Loop Knot](kb://knot-loop-non-slip-loop)
