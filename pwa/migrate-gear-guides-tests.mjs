...
await edit('pwa/my-gear-routing.test.mjs',s=>{
  s=rep(s,"label:'Accessories', iconHtml:ACCESSORIES_ICON","label:'Equipment', iconHtml:ACCESSORIES_ICON");
...
await edit('pwa/kb-routing.test.mjs',s=>rep(s,"label:'Equipment', icon:'🧰', description:'Rigs, presentations, and gear guides\\.'","label:'Gear Guides', icon:'🧰', description:'Equipment, rigs, and presentations reference'"));
