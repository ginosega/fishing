...
export async function verifyAcceptedBatch(dist=false){
 ...
 if(dist){
  ...
  assert.equal(builtKb.dataVersion,'2026-09-08-kb-v1-cranberry-lake-picture-1');
  for(const p of plans){
