...
Current source references: [Gear model](pwa/gear-model.js), [KB/Catch model](pwa/kb-model.js), [Gear persistence](pwa/gear-store.js), [Gear UI](pwa/gear-app.js), [KB UI](pwa/kb-app.js), [KB authoring](pwa/kb-authoring-model.js), [Media resolution](pwa/kb-picture-model.js), [Build](pwa/build.mjs), [Local media](pwa/apply-local-media.mjs), [Service worker](pwa/sw.js), [Production workflow](.github/workflows/fishing-pwa-build.yml).
