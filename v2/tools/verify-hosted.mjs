...
const preview=new URL('v2-preview/',root).href;
...
try{
 ...
 await page.goto(root);await page.getByRole('button',{name:/My Gear Browse/}).waitFor();report.browser='v1 navigation, preview with existing root worker, image viewer, complete offline reload, return to v1 passed';
 await context.close();
