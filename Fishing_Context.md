...
- Project goal: GitHub Markdown replaces OneNote for fishing/kayak reference use, including clickable inline links in GitHub Preview.
...
- Rod: Daiwa Tatula XT 7' Medium Fast Spinning, part `TATULAXT702MFS`.
- Reel: Daiwa Exceler LT, part `EXELT2500D-XH`, 6.2:1.
- Main line: Sufix 832 15 lb Hi-Vis Yellow braid, part `660-115Y`.
...
- Primary role: spinnerbaits, chatterbaits, crankbaits, jigs, soft jerk shad, swimbaits, topwater, and kayak trolling heavier plugs such as Flicker Shad.

### Shore trout spincast

- Old Pflueger President push-button/spincast reel on a short rod.
- Recommended line: 6 lb monofilament, e.g. Berkley Trilene XL.
- Primary role: simple shore trout bottom/bobber rigs.

Details: `Topics/Rods_Reels_Line_Knots.md`.

## Current inventory routing

- Owned rods/reels/kayak/electronics/tools/accessories: `Fishing_Gear_Registry.md`.
- Lures, bait, hooks, sinkers, snaps, swivels, and tackle: `Fishing_Tackle_Inventory.md`.
- Technique-specific use guidance: `Topics/Fishing_Techniques.md`.
- Location-specific plans and access notes: `Topics/Local_Waters_Locations.md`.
- Actual catches and no-bite observations: `Topics/Trip_Logs_Field_Observations.md`.
...
- Jacob's tackle is shared, but Jacob's smaller Rapalas should normally be prioritized for his spinning rod.
