...
The seven deferred pictures are Gear Tsuridamashii ball-bearing snap swivels, Rapala Original Floating F-3, Mack's Pee Wee Hoochie and River2Sea Whopper Plopper60; KB Perch, Popper and Whopper Plopper. Generic inline-spinner is optional. `pwa/migration/media-decisions.json` records explicit acceptance of their absence while the original migration report remains preserved. I will supply pictures later; do not acquire them automatically.
...
The source-equivalence waiver stands; no separate physical-device/IndexedDB export or inspection is claimed. Retain old browser stores and reconcile later-discovered local-only data before retirement. FISH076 is DONE; FISH078 picture additions and P2 are DEFERRED. Unrelated backlog remains; next unused task ID084. Update Context, Decision Log, TODO, README, affected source/technical/release records and this bootstrap after actual milestones; cross-check before handoff.
