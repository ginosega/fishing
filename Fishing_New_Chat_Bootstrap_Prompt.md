...
The source-equivalence waiver stands; no separate physical-device/IndexedDB export or inspection is claimed. Retain old browser stores and reconcile later-discovered local-only data before retirement. FISH076, FISH078 and FISH083 are DONE; P2 FISH077 remains DEFERRED. FISH084–090 and FISH092–094 are DONE and fully verified in production. FISH091 remains requirements-only in draft PR96, WAITING ON USER requirements signoff and unimplemented. All originally required missing pictures are resolved; the historically optional generic inline-spinner has the user-supplied Kingforest picture through FISH088, FISH089 adds the four validated location pictures, and FISH094 associates the validated Trout Fishing picture without changing its Notes. Unrelated backlog remains; next unused task ID is FISH-TODO-095. Update Context, Decision Log, TODO, README, affected source/technical/release records and this bootstrap after actual milestones; cross-check before handoff.